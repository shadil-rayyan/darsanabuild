"use client";
import ReviewForm from "@/components/adminprogram/reviewform";
...
const AddProgramForm: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Handle review submissions here if needed
    // For example:
    // submitReview(review1);
    // submitReview(review2);
    // submitReview(review3);
  };
  ...
  return (
    <div className="mr-8 p-8">
      ...
      {/* Review Form Section */}
      <div className="mt-10">
        <h2 className="text-xl font-bold mb-6">Add Reviews</h2>
        <div className="flex space-x-4">
        <ReviewForm />
        <ReviewForm />
        <ReviewForm />
        </div>
        {/* You can add more ReviewForm components as needed */}
      </div>
